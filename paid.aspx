<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paid.aspx.cs" Inherits="WebApplication2.paid" %>
...
<body class="dashboard">
    ...
    <table style="margin-left:auto;margin-right:auto;">
        ...
        <table style="margin-left:auto;margin-right:auto;">
                <tr class="auto-style3">
                    <td><asp:Button ID="pay" runat="server" Text="Paid" OnClick="pay_Click" /></td>
                </tr>
            </table>
    ...
    <br /><br />
        <table style="margin-left:auto;margin-right:auto;">
                <tr class="auto-style3">
                    <td><asp:Label id="Submitted" runat="server" ></asp:Label></td>
                </tr>
            </table>
