<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updatePassF.aspx.cs" Inherits="WebApplication2.updatePassF" %>
...
<body class="dashboard">
    ...
    <div>
       <table style="margin-left:auto;margin-right:auto;">
        ...
        <tr style="text-align:center"><td><asp:textbox ID="sfname" runat="server" Width="600px" BorderColor="#5B6098"></asp:textbox></td></tr>
