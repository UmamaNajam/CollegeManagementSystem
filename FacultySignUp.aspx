<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FacultySignUp.aspx.cs" Inherits="WebApplication2.FacultySignUp" %>
...
<body>
    ...
    <table class="centertable">
        ...
        <tr>
            <td class="auto-style1">
                <asp:Label ID="Label6" runat="server" Text="Join Date"></asp:Label></td>
            <td class="auto-style1">
                <asp:TextBox ID="jd" runat="server" ></asp:TextBox></td>
        </tr>
        <tr>
            <td class="auto-style1">
