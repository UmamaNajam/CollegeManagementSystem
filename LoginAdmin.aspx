...
<body>
    <h1 style="text-align:center;color:white;font-size:60px;border-bottom:solid white; border-top:solid white">Welcome Admin</h1>
    <br />
        <br />

        <p style="text-align:center;color:white;font-size:20px; font-family:Arial; background-color:purple" >Enter your credentials to login</p>
     <br />
        ...
        <tr class="auto-style1">
            ...
            <td>
                <asp:Button ID="btnLogin" runat="server" Text="Login" OnClick="btnLogin_Click" />
                 <asp:Button ID="Button1" runat="server" OnClick="checkbox" Text="See Password" />
            </td>
        </tr>
