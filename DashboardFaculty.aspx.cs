...
{
    public partial class DashboardFaculty : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            Functions f = new Functions();
            DataSet ds = f.FacultyInfoForFaculty(Session["username"].ToString());
            ...
            JoinDate.Text = ds.Tables[0].Rows[0]["JoinDate"].ToString();
